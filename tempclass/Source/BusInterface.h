...
//second range of commands 0x8090 - 0x80AF
#define _BUS_IF_SET_SDIAS_MODE            16#8090  // Used for BusInterfaceVaran to simulate the init calls (AddAccesses, InitModule) like the Sdiasmanager HWC
#define _BUS_IF_ADD_CTRL_DO               16#8091  // Add a data object (the same function like _BUS_IF_ADD_DO but with control access instead of memory access)
#define _BUS_IF_ADD_ISO_READ_DATA         16#8092   
#define _BUS_IF_ADD_ISO_WRITE_DATA        16#8093
#define _BUS_IF_SET_ISO_WRITE_DATA        16#8094
...
#define _BUS_IF_DOLISTADD_AVAILABLE       11
...
//*****************************************************************************
    ...
    (
      ...
      _BUS_IF_RETVAL_ERROR_VERSION_NOT_SUPPORTED,
      _BUS_IF_RETVAL_ERROR_INVALID_RETCODE
    )$UDINT;
    ...
    t_AddDOCfg : STRUCT
      ...
      // Not Compatible with BusInterfaceSdias, use t_BusIFRDWR for changeable DOs
      b_DOIsChangable     : BOOL;
