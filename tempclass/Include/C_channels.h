...
typedef struct SvrCh_taskcreation_PTofCls_checkDirectory 
  {
    CHMETH *pMeth;
    taskcreation dData;
    SVRDSC *pDsc;
  } SvrCh_taskcreation_PTofCls_checkDirectory;

typedef struct CltCh_taskcreation_PTofCls_checkDirectory 
  {
    struct SvrCh_taskcreation_PTofCls_checkDirectory *pCh;
    taskcreation dData;
    SVRCHCMD *pCmd;
  } CltCh_taskcreation_PTofCls_checkDirectory;
...
typedef struct CltChCmd_DSComm 
  {
    struct SvrChCmd_DINT *pCh;
    DINT dData;
    DSComm *pCmd;
...
typedef struct CltChCmd_DSComm_Interface 
  {
    struct SvrChCmd_DINT *pCh;
    DINT dData;
    DSComm_Interface *pCmd;
  } CltChCmd_DSComm_Interface;
...
typedef struct CltChCmd_Lasal32 
  {
    struct SvrChCmd_DINT *pCh;
    DINT dData;
    Lasal32 *pCmd;
...
typedef struct SvrCh__LSLONL_STATUS_PLC 
  {
    CHMETH *pMeth;
    _LSLONL_STATUS_PLC dData;
    SVRDSC *pDsc;
  } SvrCh__LSLONL_STATUS_PLC;
...
typedef struct SvrChCmd_Do_MyMethods_PTofCls_Lasal32User 
  {
    CMDMETH *pMeth;
    Do_MyMethods dData;
    SVRDSC *pDsc;
  } SvrChCmd_Do_MyMethods_PTofCls_Lasal32User;
