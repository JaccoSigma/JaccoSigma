...
TYPE
  ...
  CltCh_IO_State : STRUCT
    ...
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  SvrCh_taskcreation_PTofCls_checkDirectory : STRUCT
    pMeth : ^CHMETH;
    dData : checkDirectory::taskcreation;
    pDsc : ^SVRDSC;
  END_STRUCT;
  CltCh_taskcreation_PTofCls_checkDirectory : STRUCT
    pCh : ^SvrCh_taskcreation_PTofCls_checkDirectory;
    dData : checkDirectory::taskcreation;
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  SvrCh_UDINT : STRUCT
  ...
  SvrCh__INITSTEPS_PTofCls_SafetyUDP : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh__LSLONL_STATUS_PLC : STRUCT
    pMeth : ^CHMETH;
    dData : _LSLONL_STATUS_PLC;
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_BDINT : STRUCT
    pMeth : ^CHMETH;
  ...
  SvrCh_t_s_SdiasFWStateStandard_PTofCls_SdiasBase : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrChCmd_Do_MyMethods_PTofCls_Lasal32User : STRUCT
    pMeth : ^CMDMETH;
    dData : Lasal32User::Do_MyMethods;
    pDsc : ^SVRDSC;
  END_STRUCT;
